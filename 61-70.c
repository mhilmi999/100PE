61. Nosy Duck
Penjelasan : program untuk mengurutkan bilangan yang diinputkan dari besar ke kecil. 
algoritma sort nya adalah dengan membagi dua barisan tersebut, kemudian dicek awal dan akhir, 
apabila tidak sesuai (kecil ke besar) maka ditukar sampai bertemu di tengah baris bilangan, 
kemudian barisan tersebut dibagi 2, depan dan belakang, setelah itu sort lagi dari awal sampai tengah dan 
dari tengah sampai akhir, lanjut cek awal dan akhir dari tiap bagian, kemudian barisan depan dan belakang masing masing
dibagi 2 lagi dan seterusnya

Input: baris pertama input testcase, baris kedua itu tiap test case inputkan jumlah bilangan yang akan diurutkan, 
baris berikutnya masukkan bilangan bilangan yang akan diurutkan
...
int i=left,j=right,data=(arr[right]+arr[left])/2; while(i<=j){
while(arr[i]>data)i++;
...
Penjelasan : program untuk mengecek sebuah barisan bilangan dimana jika bilangan pertama ganjil, 
maka setiap lompat 1 bilangan seterusnya bernilai ganjil, bagitu pula bila bilangan pertama genap, 
setiap lompat 1 bilangan bernilai genap.
...
63. Jumlah Pangkat
Penjelasan:”kurang tau maksut soalnya, programnya membuat sebuah array dengan 
bilangan 0 1 5 2 8 3 9 2 8 7 7 8 4 7 3 8 4 1 5 4…dst (dimulai dari 0)”
...
memset(arr,0,sizeof(arr)); //mereset semua nilai 
arr = 0 precomp(); //menjalankan fungsi precom 
scanf("%d",&a); //input test case
...
64. Tunnel of Love
Penjelasan : program tersebut untuk mengecek 4 (a1,a2,b,c) buah bilangan yang diinputkan 
Bersama dengan 1 (kapal) bilangan dibelakangnya, bila a1+a2+b+c <= kapal print 0. Bila a1+a2 >= kapal print next queue. 
 Bila b > kapal-a1-a2-c print 3. Bila c > kapal-a1-a2-b print 4. Bila (b+c) > kapal-a1-a2 print perfect ride.
...
if(sum<=kapal)printf("0\n"); //jika jumlah kurang dari berat kapal 
else if((a1+a2)>kapal)printf("NEXT QUEUE\n");
...
65. Dividing Sweets
Penjelasan : Inout berupa bilangan 1 dan 2 yang merupakan jenis permen. Bila ada permen jenis 1 dan jumlahnya permen 1
 genap print 0. Bila ada permen 1 dan jumlahnya ganjil print 1. Bila tidak ada permen 1 dan jumlah permen 2 ganjil print 2. 
 Bila tidak ada permen 1 dan jumlah permen 2 genap print 0.

Input : baris pertama berupa test case. Baris berikutnya jumlah permen tiap testcase. 
Baris berikutnya barisan bilangan permen
...
int main(){ 
 ...
 for(i=1;i<=a;i++){ 
  ...
  for(j=0;j<b;j++){ 
   ...
   if(m==1) c++; //tambah c bila isi permen 1 
   else if(m==2) d++; //tambah d bila isi permen 2 
  } 
...
67. Play, play, play!
Penjelasan : program untuk menghitung menghitung bilangan. Pertama tama input arisan bilangan. 
 Kemudian sort, algoritma sort nya adalah dengan membagi dua barisan tersebut, kemudian dicek awal dan akhir, 
apabila tidak sesuai (kecil ke besar) maka ditukar sampai bertemu di tengah baris bilangan, 
kemudian barisan tersebut dibagi 2, depan dan belakang, 
setelah itu sort lagi dari awal sampai tengah dan dari tengah sampai akhir, 
lanjut cek awal dan akhir dari tiap bagian, kemudian barisan depan dan belakang masing masing dibagi 2 lagi 
dan seterusnya setlah di sort jumlahkan seluruh bilangan digit ganjil, juga jumlahkan seluruh bilangan digit genap. 
Kemudian selisihkan.
...
Penjelasan : program yang menghasilakn sebuah segi empat dimana seperti papan catur, 
selang seling antara symbol * (bintang) dan titik (.)
...
else printf("."); //selain itu print titik 
}
...
Penjelasan : program untuk membuat pola karakter dimana tiap satuan bilangan melambangkan sebuah petak dengan 
tepianya berupa bintang dan tengahnya titik.
